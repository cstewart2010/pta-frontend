<template>
    <div class="col-12 col-md-6 text-dark bg-primary bg-gradient" style="text-align: center;">
        <div class="row">
        ...
        <div class="row border-bottom border-start">
            <select class="form-select m-1 col text-dark bg-primary" name="item" style="max-width: 150px" v-model="addedItem">
    ...
    <use-item-modal :item="itemToUse" :type="'trainer'" />
</template>
